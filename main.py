...
# Enable Plotly debugging mode
pio.renderers.default = "browser"
pio.renderers.render_on_display_env = True
...
def visualize_data(metric):
    ...
    if metric == "weight":
        ...
        backend_scripts.visualize_height(fig, health_data)
    elif metric == "bp":
...
height_button = ttk.Button(viz_frame, text="Height Trend", command=lambda: visualize_data("height"))
height_button.pack(pady=5)
